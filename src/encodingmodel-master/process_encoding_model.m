...
function [relative_contrib,Fstat_mat,full_R2_vec,predicted_gcamp,B_all,pred_inds_cell_opt] = process_encoding_model(pred_allmat, pred_inds_cell, neural_act_mat, pred_types_cell,approach, trial_types_to_match)
if nargin<5
    approach = 'norefit';
end
if nargin<6
    ...
    if num_cont_inds>0
        ...
        for degctr = 1:size(all_degs_mat,1)
            ...
            if nargout<5
                ...
                [cur_R2,cur_predicted,curB] = get_CV_R2(full_predmat_cell,cur_neural_act_mat,test_trials_folds,train_trials_folds,trial_length_vec(cur_good_trials),[],approach,trial_types_to_match);
