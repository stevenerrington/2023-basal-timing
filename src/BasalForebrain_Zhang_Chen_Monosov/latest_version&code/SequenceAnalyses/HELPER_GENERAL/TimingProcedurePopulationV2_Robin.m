...
addpath('Y:\Ilya\ROBIN\TimingProcedure\');
D=dir ('Y:\Ilya\ROBIN\TimingProcedure\T*.mat');
...
save timingproceduresummary2Robin.mat savestruct
clc; clear all;
 

clc; clear all; close all; 
%load('giftforilya.mat')
load('timingproceduresummary2Robin.mat')
linew=1.5;
linew1=0.5;
