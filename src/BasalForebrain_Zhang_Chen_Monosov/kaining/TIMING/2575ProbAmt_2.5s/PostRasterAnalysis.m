...
temp=SDFcs_n([completedtrial],6500:7500);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[R,p]=(rocarea3(SDFcs_n((prob0),5000:7500), SDFcs_n((prob100),5000:7500)))
savestruct(xzv).ROC_value=R;
savestruct(xzv).ROC_valueP=p;

[R,p]=(rocarea3(SDFcs_n([(prob100'); (prob0')],5000:7500), SDFcs_n((prob50),5000:7500)))
...
%last 250ms
clear t1 t2 t3 t4 t5
t1=nansum(Rasters(prob100,4000-RangeEarly:4000)')';
t2=nansum(Rasters(prob75,4000-RangeEarly:4000)')';
t3=nansum(Rasters(prob50,4000-RangeEarly:4000)')';
t4=nansum(Rasters(prob25,4000-RangeEarly:4000)')';
t5=nansum(Rasters(prob0,4000-RangeEarly:4000)')';
...
%last 250ms
clear t1 t2 t3 t4 t5
t1=nansum(Rasters(a100,4000-RangeEarly:4000)')';
t2=nansum(Rasters(a75,4000-RangeEarly:4000)')';
t3=nansum(Rasters(a50,4000-RangeEarly:4000)')';
t4=nansum(Rasters(a25,4000-RangeEarly:4000)')';
t5=nansum(Rasters(a0,4000-RangeEarly:4000)')';
t1(1:length(t1),2)=5;
t2(1:length(t2),2)=4;
t3(1:length(t3),2)=3;
t4(1:length(t4),2)=2;
