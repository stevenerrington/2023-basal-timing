...
addpath('/Users/Ilya/Desktop/NIHBFrampingdata2575/MRDR/');
...
for zzzz=1:length(SPIKES)
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    cd /Users/Ilya/Desktop/NIHBFrampingdata2575/MRDR/
    d=mrdr('-a', '-d', TESTFILE);
    cd ..
    
     cd /Users/Ilya/Dropbox/kaining/TIMING/2575ProbAmtNIHBFrampingdata_1.5s/

    %cd 'C:\Users\Ilya Monosov\Dropbox\kaining\TIMING\2575ProbAmtNIHBFrampingdata_1.5s\'
    d=d(2:length(d));
    d=d(1:length(d)-1);
