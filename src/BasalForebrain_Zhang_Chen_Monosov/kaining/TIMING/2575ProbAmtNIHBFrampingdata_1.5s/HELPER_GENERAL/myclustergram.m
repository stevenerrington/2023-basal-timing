...
clustStruct.linkageargs = {'ward'};
%clustStruct.linkageargs = {'average'};
%clustStruct.dendroargs = {};
clustStruct.dendroargs = {'colorthreshold','default'};
...
clustStruct.optLeafOrder = true; %max(size(data)) <= 1000;
...
hImage1= image(colormapify(clustStruct.data(perm1,:),[0 1],'b','w','r'));
