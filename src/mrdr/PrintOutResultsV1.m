...
load('probamt.mat');
addpath('C:\Users\Ilya\Dropbox\HELPER\HELPER_GENERAL'); %keep helpers functions here
dosubtraction=2;
...
shift_plot=nanmean(nanmean(SF50prob100(:,5000:5015)));
%x1=[500,500]; y1=[0,150];
%x2=[1500,1500]; y2=[0,150];
%x3=[3000,3000]; y3=[0,150];
region1=[1600:1850];
...
p=plot(nanmean(SF50prob0(:,5000:7000))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
%hold on; plot(x1,y1); hold on; plot(x2,y2); hold on; plot(x3,y3);
%axis square; ylim([0 YLIMM]); xlim([0 4000])
hold on
...
p=plot(nanmean(SF50prob25(:,5000:6500))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob25r(:,6500:7000))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob25nr(:,6500:7000))-shift_plot,'r'); hold on
set(p,'LineWidth',LINESIZE)
%hold on; plot(x1,y1); hold on; plot(x2,y2); hold on; plot(x3,y3);
hold on
x=[1500,1500]; y=[-60,60]; plot(x,y,'k'); hold on;
axis([0 2250 yl1 yl2])
%axis square; ylim([0 YLIMM]); xlim([0 2000])
%yyy=ylim;
%line([region1(1) region1(end)], [yyy(1) yyy(1)] , 'Color', [0 0 0 ],'LineWidth',2);
set(gca, 'XTick',[800 1900], 'XTickLabel',{'0\newlineTime from CS onset' '1.5 seconds', })


nsubplot(250,250,12:62,61:80)
p=plot(nanmean(SF50prob50(:,5000:6500))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob50r(:,6500:7000))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob50nr(:,6500:7000))-shift_plot,'r'); hold on
set(p,'LineWidth',LINESIZE)
%hold on; plot(x1,y1); hold on; plot(x2,y2); hold on; plot(x3,y3);
hold on
x=[1500,1500]; y=[-60,60]; plot(x,y,'k'); hold on;
...
p=plot(nanmean(SF50prob75(:,5000:6500))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob75r(:,6500:7000))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
p=plot(1500:2000,nanmean(SF50prob75nr(:,6500:7000))-shift_plot,'r'); hold on
set(p,'LineWidth',LINESIZE)
%hold on; plot(x1,y1); hold on; plot(x2,y2); hold on; plot(x3,y3);
hold on
x=[1500,1500]; y=[-60,60]; plot(x,y,'k'); hold on;
...
p=plot(nanmean(SF50prob100(:,5000:7000))-shift_plot,'k'); hold on
set(p,'LineWidth',LINESIZE)
%hold on; plot(x1,y1); hold on; plot(x2,y2); hold on; plot(x3,y3);
hold on
x=[1500,1500]; y=[-60,60]; plot(x,y,'k'); hold on;
...
signrank(nanmean(SF50prob25r(:,region)'),nanmean(SF50prob25nr(:,region)'))
signrank(nanmean(SF50prob50r(:,region)'),nanmean(SF50prob50nr(:,region)'))
signrank(nanmean(SF50prob75r(:,region)'),nanmean(SF50prob75nr(:,region)'))


t1=(SF50prob25r)-(SF50prob25nr);
t2=(SF50prob50r)-(SF50prob50nr);
t3=(SF50prob75r)-(SF50prob75nr);
...
linew=2;
nsubplot(250,250,12:62,151:170)
plot(nanmean(SF50prob25r)-nanmean(SF50prob25nr),'r','LineWidth',linew); hold on
plot(nanmean(SF50prob50r)-nanmean(SF50prob50nr),'g','LineWidth',linew); hold on
plot(nanmean(SF50prob75r)-nanmean(SF50prob75nr),'b','LineWidth',linew); hold on
...
%    text(1700,22,['NS'])
%end
axis([1300 1900 -20 20])
line([region1(1) region1(end)], [-19 -19] , 'Color', [0 0 0 ],'LineWidth',2);

%axis([1300 1900 yyy(1) yyy(2)])
%axis([1600 1850 -10 10])
...
load('\\128.252.37.174\Share1\Charlie\Figure5\MRDR_CHARLIE\probamt.mat');
