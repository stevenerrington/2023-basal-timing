for neuron_i = 1:size(bf_data,1)
    ...
    plot(bf_data.fano(neuron_i).time,bf_data.fano(neuron_i).raw.prob0)
    plot(bf_data.fano(neuron_i).time,bf_data.fano(neuron_i).raw.prob25)
    plot(bf_data.fano(neuron_i).time,bf_data.fano(neuron_i).raw.prob50)
    plot(bf_data.fano(neuron_i).time,bf_data.fano(neuron_i).raw.prob75)
    plot(bf_data.fano(neuron_i).time,bf_data.fano(neuron_i).raw.prob100)
