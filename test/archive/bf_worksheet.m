...
My_LGD = legend({'100%','75%','50%','25%','0%'}, 'Location', 'SouthOutside','Orientation','Horizontal');
My_LGD.NumColumns = 3;

title('NIH Ramping Neurons')
% Legend properties
% legend('100%', '75%', '50%', '25%', '0%' , 'Location', 'southoutside');

subplot(2,2,3)
data_a = [D1; D2; D3; D4; D5]';
bar(data_a)
set(gca,'xticklabel',{'Fixation', 'Pre-CS', 'Post-CS', 'Mid', 'Pre-outcome', 'Post-outcome'})
hline(1, 'k')
My_LGD = legend({'100%','75%','50%','25%','0%'}, 'Location', 'SouthOutside','Orientation','Horizontal');
My_LGD.NumColumns = 3;
xtickangle(45)
