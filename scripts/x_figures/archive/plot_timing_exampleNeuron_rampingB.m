...
example_neuron_i = 6;
plot_trial_types = {'fractal6201_d','fractal6201_nd'};
...
clear figure_plot
color_scheme = parula(length(plot_trial_types));
...
filename = fullfile(dirs.root,'results','raster_sdf_fano_timingtask_figure_rampingB.pdf');
