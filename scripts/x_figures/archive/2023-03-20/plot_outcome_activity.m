...
bf_population_CS_outcome = plot_population_CSoutcome(bf_data_CS(bf_datasheet_CS.cluster_id == 2,:),bf_datasheet_CS, plot_trial_types,params,1);
...
params.plot.colormap = [0 0 0; 1 0 0];
striatum_population_CS_outcome = plot_population_CSoutcome(striatum_data_CS,striatum_datasheet_CS, plot_trial_types,params,1);
...
params.plot.colormap = [0 0 0; 1 0 0];
bf_population_trace_outcome = plot_population_traceoutcome(bf_data_traceExp,plot_trial_types,params,1);
...
params.plot.colormap = [0 0 0; 1 0 0];
striatum_population_trace_outcome = plot_population_traceoutcome(striatum_data_traceExp,plot_trial_types,params,1);
