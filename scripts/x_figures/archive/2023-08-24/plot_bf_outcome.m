...
figure_plot(1,1)=gramm('x',plot_time,'y',plot_sdf_data,'color',plot_label_rwd,'subset',strcmp(plot_category_label,'Ramping'));
...
% Fano factor >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
figure_plot(2,1)=gramm('x',plot_time,'y',plot_fano_data,'color',plot_label_rwd,'subset',strcmp(plot_category_label,'Ramping'));
