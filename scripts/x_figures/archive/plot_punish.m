...
plot_trial_types = trialtype_plot.punish;
...
figure_plot(1,1).set_color_options('map',color_scheme_punish);
...
figure_plot(3,1).set_color_options('map',color_scheme_punish);
...
figure_plot(4,1).axe_property('XLim',xlim_input_CS,'YLim',[-3 5],'XTick',[],'XColor',[1 1 1]);
figure_plot(4,1).set_names('x','','y','');
figure_plot(4,1).set_color_options('map',color_scheme_punish);
...
figure_plot(5,1).set_color_options('map',color_scheme_punish);
