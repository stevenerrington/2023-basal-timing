...
% CS Onset ----------------------------------------------------------------
% Raster plot
figure_plot(16,1)=gramm('x',plot_spk_data,'color',plot_label);
figure_plot(16,1).geom_raster();
figure_plot(16,1).axe_property('XLim',xlim_input_CS,'XTick',[],'YTick',[],'XColor',[1 1 1],'YColor',[1 1 1]);
figure_plot(16,1).set_names('x','','y','');
figure_plot(16,1).set_color_options('map',color_scheme);
figure_plot(16,1).no_legend;

% Spike density function
figure_plot(17,1)=gramm('x',plot_time,'y',plot_sdf_data,'color',plot_label);
figure_plot(17,1).stat_summary();
figure_plot(17,1).axe_property('XLim',xlim_input_CS,'YLim',ylim_input,'XTick',[],'XColor',[1 1 1],'YTick',[]);
figure_plot(17,1).set_names('x','','y','');
figure_plot(17,1).set_color_options('map',color_scheme);
figure_plot(17,1).no_legend;

% Fano factor
figure_plot(18,1)=gramm('x',data_in.fano(example_neuron_i).time,'y',plot_fano_data,'color',plot_fano_label);
figure_plot(18,1).geom_line();
figure_plot(18,1).axe_property('XLim',xlim_input_CS,'YLim',[0 2],'XTick',[],'XColor',[1 1 1],'YTick',[]);
figure_plot(18,1).set_names('x','','y','');
figure_plot(18,1).set_color_options('map',color_scheme);
figure_plot(18,1).geom_hline('yintercept',1,'style','k--');
figure_plot(18,1).no_legend;
...
% CS Onset ----------------------------------------------------------------
% Spike density function
figure_plot(19,1)=gramm('x',plot_time,'y',plot_sdf_data_pop,'color',plot_label_pop);
figure_plot(19,1).stat_summary();
figure_plot(19,1).axe_property('XLim',xlim_input_CS,'YLim',[-3 4],'XTick',[],'XColor',[1 1 1],'YTick',[]);
figure_plot(19,1).set_names('x','','y','');
figure_plot(19,1).set_color_options('map',color_scheme);
figure_plot(19,1).no_legend;

% Fano factor
figure_plot(20,1)=gramm('x',data_in.fano(example_neuron_i).time,'y',plot_fano_data_pop,'color',plot_fano_label_pop);
figure_plot(20,1).stat_summary();
figure_plot(20,1).axe_property('XLim',xlim_input_CS,'YLim',[0 2],'YTick',[]);
figure_plot(20,1).set_names('x','Time from CS Onset (ms)','y','');
figure_plot(20,1).set_color_options('map',color_scheme);
figure_plot(20,1).geom_hline('yintercept',1,'style','k--');
figure_plot(20,1).no_legend;
