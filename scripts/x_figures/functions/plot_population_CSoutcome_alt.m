function figure_plot = plot_population_CSoutcome_alt(data_in,datasheet_in,plot_trial_types,params)
...
figure_plot(1,1)=gramm('x',plot_time,'y',plot_sdf_data,'color',plot_group,'subset',strcmp(plot_label_rwd,'1_omitted'));
...
% Fano factor >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
figure_plot(2,1)=gramm('x',plot_time,'y',plot_fano_data,'color',plot_group,'subset',strcmp(plot_label_rwd,'1_omitted'));
